...
export default function GeneralSaleComponent(props) {
    ...
    const _updates = async () => {
        ...
        setPending(
            Number(
                salesSettings.totalToSell -
                    salesSettings.remaining -
                    salesSettings.sold
            )
        );
                                        ...
                                        {Date.now() >= whitelistTime ? (
                                            <>
                                                ...
                                                <p>
                                                    ...
                                                    via Entrepot's escrow
                                                    platform. There are no
                                                    refunds or returns, once a
                                                    transaction is made it can
                                                    not be reversed. Entrepot
                                                    provides a transaction
                                                    service only. By clicking
                                                    one of the buttons above you
                                                    show acceptance of our{" "}
                                                    <a
                                                        href="https://docs.google.com/document/d/13aj8of_UXdByGoFdMEbbIyltXMn0TXHiUie2jO-qnNk/edit"
                                                        target="_blank"
                                        ...
                                        <p>
                                            <strong>
                                                ...
                                                >
                                                    ...
                                                    NFTs available, but not all
                                                    sales have settled yet. If
                                                    these transactions do not
                                                    settle in time, the NFTs
                            ...
                            <>
                                <p>
                                    <strong>
                                        ...
                                        >
                                            Sorry, the sale is now over! You can
                                            grab your NFT from the marketplace!
                                        </span>
                                    </strong>
                                </p>
                                <Button
